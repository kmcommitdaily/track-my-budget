...
export function SummaryCard() {
  const { getTotalIncome, getTotalBudget, getTotalExpenses, getRemainingBudget, getRemainingIncome } = useFinance()
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-muted-foreground">Remaining Income</p>
              <p className="text-2xl font-bold">${getRemainingIncome().toLocaleString()}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">${getRemainingBudget().toLocaleString()}</p>
            </div>
          </div>
